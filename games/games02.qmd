...
viewof n = Inputs.number([1, Infinity], {step: 1, label: "n", value: 2000})
...
function* pachinko(random, extent, width = 600, height = 400) {
  const radius = 2;
...
function* pachinkov(values, extent, width = 600, height = 400) {
  const radius = 2;
  const dodge = dodger(radius * 2 + 1);
  const margin = {top: 0, right: 30, bottom: 20, left: 30};
  draw100;
