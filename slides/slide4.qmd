...
## {{< fa solid database >}} Crop yield due to nitrogen and rainfall
...
## Fitting multiple linear regression model in R
...
## Goodness-of-fit measures for the additive model 
...
## Fitting interaction effects in R
...
## Comparing to a _nested model_ using the F-test
...
## Comparing models using AIC or BIC 
...
## <i class="fas fa-code"></i> Data generating process for crop yield
