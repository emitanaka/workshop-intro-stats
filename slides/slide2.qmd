...
- **Test statistic**: $t = \dfrac{\bar{X}_1 - \bar{X}_2}{SE(\bar{X}_1 - \bar{X}_2)} \sim t_{n_1 + n_2 - 2}$, where: 
  - $\bar{X}_1$ and $\bar{X}_2$ are the sample means for population 1 and 2, respectively.
