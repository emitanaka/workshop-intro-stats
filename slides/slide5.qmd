...
## [Two-way ANOVA model]{.page-rproj}
...
## [Longevity of fruitflies]{.page-data} {background-color="#F5EDDE"}
...
[<i class="fas fa-terminal"></i> Go to Exercise 1](/exercises/exercise05.html){.button-next} <br><br>
