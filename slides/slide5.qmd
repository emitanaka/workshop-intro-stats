...
- For $i=1, \ldots, t$ and $j = 1, \ldots, n_i$, $$y_{ij} = \beta_0 + \beta_{1i} + \epsilon_{ij}, \qquad \epsilon_{ij}\stackrel{iid}{\sim} N(0, \sigma^2),$$ where $t$ is the number of levels of the categorical variable and $n_i$ is the number of observations in the $i$-th level of the factor.
