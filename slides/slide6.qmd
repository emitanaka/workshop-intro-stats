...
# [Breast cancer diagnosis]{.page-data} {background-color="#F5EDDE" .scrollable}
...
# [Concepts]{.page-break} {background-color="#F5EDDE"}

##  [Odds of a class]{.page-concept}
...
## [Logistic and Logit Functions]{.page-concept}
...
# [Logistic regression]{.page-break} {background-color="#F5EDDE"}



## [Logistic regression for a binary response]{.page-concept}
...
## [Logistic regression for a binary response]{.page-rproj}
...
#| autorun: true
#| code-fold: true
cancer <- read.csv("https://emitanaka.org/workshop-intro-stats//data/cancer.csv")
...
## [Logistic regression for a factor response]{.page-rproj}
...
## [Interpretation of logistic regression]{.page-concept}
...
## [Predicting from logistic regression]{.page-rproj}
...
## [Logistic regression is a linear classifier]{.page-concept}
...
# [Germination of seeds]{.page-data} {.scrollable background-color="#F5EDDE"}
...
## [Logistic regression with count responses]{.page-rproj}
...
## [Logistic regression with proportion responses]{.page-rproj}
...
# [Chi-square test]{.page-break}

## [Chi-square test for goodness-of-fit]{.page-rproj}
...
- _Does the observed distribution differ from the global distribution?_
...
```{webr}
observed <- c(85, 40, 15, 60)
chisq.test(observed, p = c(0.4, 0.25, 0.1, 0.25))
```



## [Chi-square test for independence]{.page-rproj}

```{webr}
#| autorun: true
data(Aspirin, package = "abd")
(tab <- with(Aspirin, table(treatment, cancer)))
```

- _Is the relative risk of cancer rate independent of aspirin use?_
  - $H_0$: $P(\text{cancer} | \text{aspirin}) = P(\text{cancer} | \text{placebo})$ vs.
  - $H_A$: $P(\text{cancer} | \text{aspirin}) \neq P(\text{cancer} | \text{placebo})$.
...
# [Summary]{.page-break} {background-color="#F5EDDE"}
...
- Chi-square test can be used to test for goodness-of-fit or independence between two categorical variables.

# [Exercise time]{.page-exercise} {background-color="#F5EDDE"}

[<i class="fas fa-terminal"></i> Go to Exercise 6](/exercises/exercise06.html){.button-next} <br><br>

[<i class="fas fa-caret-square-right"></i> Next slide](/slides/slidex.html){.button-next} <br><br>

[<i class="fas fa-fast-backward"></i> Back to start](/slides/slide6.html){.button-next}
