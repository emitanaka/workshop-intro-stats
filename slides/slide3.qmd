...
[[**error**]{.primary} for the $i$-th observation, and assume $\epsilon_i \sim NID(0, \sigma^2)$, i.e. normally and independently distributed with mean 0 and variance $\sigma^2$.]{#error .absolute  .absolute top="45%" left="66%"}
