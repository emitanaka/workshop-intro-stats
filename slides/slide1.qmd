...
#| echo: false
set.seed(1)
head <- '<img src="https://emitanaka.org/workshop-intro-stats/images/Australian_Fifty_Cents_Obv.png" style="vertical-align:middle;height:1.5em;">'
tail <- '<img src="https://emitanaka.org/workshop-intro-stats/images/Australian_50c_Coin.png"  style="vertical-align:middle;height:1.5em;">'
```
...
- Possible outcomes: (A) Labor party 🔴 or (B) Coalition party 🔵 [(ignoring other parties and formation of majority or minority government)]{.f2}
...
```{webr}
#| echo: false
head <- '<img src="https://emitanaka.org/workshop-intro-stats/images/Australian_Fifty_Cents_Obv.jpg" style="vertical-align:middle;height:1.5em;">'
tail <- '<img src="https://emitanaka.org/workshop-intro-stats/images/Australian_50c_Coin.png"  style="vertical-align:middle;height:1.5em;">'
flip <- function(x, n, i) {
...
- Calculate the probability of a yield being greater than 150 tolas per plot:

```{webr}
#| input:
#| - yield_mean
#| - yield_sd
1 - pnorm(150, yield_mean, yield_sd)
```
...
## [Why normal distribution?]{.page-game}
...
**Central limit theorem**: If a random variable is the mean (or sum) of independent random values, then that value will follow a normal distribution regardless of how the individual terms are distributed. [<i class="fas fa-dice"></i>](https://emitanaka.org/workshop-intro-stats/games/games02.html){.button-next .f-headline}
...
`r` - random number generation, `d` - density function, `p` - cumulative distribution function, `q` - quantile function [<i class="fas fa-dice"></i>](https://emitanaka.org/workshop-intro-stats/games/games01.html){.button-next}
