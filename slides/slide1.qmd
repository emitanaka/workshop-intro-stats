...
# Univariate data {background-color="#F5EDDE"}
...
# Discrete variable {background-color="#F5EDDE"}

## <i class="fas fa-database"></i> Binary events in the wild
...
# Continuous variable {background-color="#F5EDDE"}


## <i class="fas fa-database"></i> Continuous data in the wild
...
# <i class="fas fa-dice"></i> Central limit theorem {background-color="#F5EDDE"}
