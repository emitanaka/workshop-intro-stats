...
How does the proportion compare to the answer in [Exercise 1.5](#exercise-1.5)?


```{webr}
#| exercise: ex_6
#| caption: Exercise 1.6
...
[<i class="fas fa-caret-square-right"></i> next slide](/slides/slide2.html){.button-next} 

[<i class="fas fa-caret-square-right"></i>  next exercise](/exercises/exercise02.html){.button-next}
